...
function loadLocations(){
    ...
    var item3parent = localStorage['item3parent'];
    ...
    if (item3parent) {
        var parent3 = document.getElementById(item3parent);
        var notecard3 = document.getElementById('item3');
        parent3.appendChild(notecard3);
    }
}
